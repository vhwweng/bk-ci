...
@Service
@Primary
class TxStoreComponentVersonLogServiceImpl:  StoreComponentVersonLogService(){
    ...
    companion object {
        private val logger = LoggerFactory.getLogger(TxStoreComponentVersonLogServiceImpl::class.java)
    }
